...
scope = "kubernetes.cluster.name = 'nonprod-k8s-cls2' and kubernetes.namespace.name = 'ovk8epic27-development-business' and kubernetes.deployment.name = 'ovk8cassndra-master-4-m4wox'"
