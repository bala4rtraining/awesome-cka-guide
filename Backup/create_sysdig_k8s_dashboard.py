...
def usage():
    ...
    print('-c|--kubernetes_cluster_name: Set name of kubernetes_cluster_name to create')
    print('-n|--kubernetes_namespace_name: Set name of kubernetes_namespace_name to create')
    print('-p|--kubernetes_deployment_name: Set name of kubernetes_deployment_name to create')
...
with open('jenkins-sh/cassandra_metrics.csv') as csvfile:
	...
	#scope = "kubernetes.cluster.name = '"+kubernetes_cluster_name+"' and kubernetes.namespace.name = '"+kubernetes_namespace_name+"' and kubernetes.deployment.name = '"+kubernetes_deployment_name+"'"
       ...
       # layout = {'col': 2, 'row': row_new, 'size_x': 6, 'size_y': 6}
